"""
Django settings for fitminder project.
...
SECRET_KEY = ')hflme#ft5aiq!yl2y@&kx*!-65#3n$f^()y1dx_wu5c0nr^ws'
...
WSGI_APPLICATION = 'fitminder.wsgi.application'
